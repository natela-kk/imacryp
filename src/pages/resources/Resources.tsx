...
export default function Resources() {
  ...
  return (
    <div className="container flex flex-col items-center">
      ...
      <p className="text-center text-white text-[27.65px] leading-[34px] mb-[185px]">
        <span className="block">A collection of 100+ tools and resources</span>
        that will help you explore, learn ar even build your own project from
        scratch
      </p>
